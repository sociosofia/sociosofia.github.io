...
assert(valid.valid.length===1,'A base cultural canônica deve conter um registro neste lote.');
...
automaticAuthor[0].autores=['Byung-Chul Han'];
...
console.log('Bloqueios do contrato cultural confirmados.');
