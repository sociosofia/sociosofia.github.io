...
assert(base.status==='em_revisao'&&expansion.status==='em_revisao','O sexto lote ampliado deve permanecer em revisão.');
...
console.log('Sexto lote cultural ampliado validado e mantido fora das bases canônicas.');
