...
assert(legacy.ids.length===18&&publicacoes.length===12&&cultural.length===8,'A aprovação editorial alterou o estado público vigente.');
...
console.log('Aprovação integral do sexto lote registrada sem publicação prematura.');
